...
<p align="center">一个实时的自更新个人学术主页</p>
...
一些例子：
- [样例页面](https://yaozhongjiang.github.io/acad-homepage.github.io/)
...
1. 配置运行环境，本站采用了github-pages -v 227, github地址详见(https://github.com/github/pages-gem), 安装方法详见(https://rubygems.org/gems/github-pages/versions/227)
